...
@Component({
  ...
  template: `
    <div class="page-header">
      <h1>Types de conditionnement</h1>
    ...
    <div class="table-wrap">
      @if (loading()) {
        ...
        <div class="state-empty">
          <p class="state-empty-title">Aucun type de conditionnement</p>
          <p class="state-empty-sub">Créez votre premier type de conditionnement.</p>
        </div>
      } @else {
        <table>
          <thead>
        ...
        <div class="modal" (click)="$event.stopPropagation()">
          ...
          <form [formGroup]="form" (ngSubmit)="submit()">
            <div class="form-group">
              <label>Libellé *</label>
              <input formControlName="libelle" placeholder="Ex : Palette, Carton, Unité…"
